...
define('DB_NAME', 'tixeebox');

/** MySQL database username */
define('DB_USER', 'tixeebox');

/** MySQL database password */
define('DB_PASSWORD', 'tixeebox2015');

/** MySQL hostname */
define('DB_HOST', '10.10.1.60');
...
define( 'AWS_ACCESS_KEY_ID', 'AKIAJP4YQP677HJWBVGQ' );
define( 'AWS_SECRET_ACCESS_KEY', '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' );
